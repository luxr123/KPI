...
sub_ss_bounce_rate       =  foreach joinSubSSBounce {    pv = sub_ss_pu::pv;                 bc = sub_ss_one_count::count; 
                                ...
                                generate sub_ss_one_count::domain,  myFloat((float)bc/pv),
                                                                    myFloat((float)retbc/retpv),
                                                                    myFloat((float)newbc/newpv),
                                                                    myFloat((float)otherbc/otherpv),
                                                                    myFloat((float)otheretbc/otheretpv),
                                                                    myFloat((float)othernewbc/othernewpv),
                                                                    myFloat((float)chinabc/chinapv),
                                                                    myFloat((float)chinaretbc/chinaretpv),
                                                                    myFloat((float)chinanewbc/chinanewpv);};
...
sub_ss_avgtime           =  foreach groupSubSSPT { FRet  = filter $1 by new  is null; FNew  = filter $1 by new  is not null;
                                ...
                                generate myConcat($time, $0.domain, mySubString($0.se), $0.se) as domain, 
                                        ...
                                        (long)AVG(FO.page_avg_time),
                                        (long)AVG(FORet.page_avg_time),
                                        (long)AVG(FONew.page_avg_time),
                                        (long)AVG(FC.page_avg_time),
                                        (long)AVG(FCRet.page_avg_time),
                                        (long)AVG(FCNew.page_avg_time);};
...
ref_total_bounce_rate     =  foreach joinRefTotalBounce {     pv = ref_total_pu::pv;                  bc = ref_total_one_count::count;
                                                      ...
                                                      othernewpv = ref_total_pu::othernewpv; othernewbc = ref_total_one_count::othernewcount;
                                                      ...
                                                      chinanewpv = ref_total_pu::chinanewpv; chinanewbc = ref_total_one_count::chinanewcount;
